...
KPI_FEATURE_COLS = [
    "no_shows", "shifts_done", "all_shifts", "perc_no_show",
    "total_orders_cpo", "total_bw_orders", "earning_per_week",
    "cpo_local_currency", "net_cpo_lc", "perc_stacking",
    "avg_sp_distance_km", "avg_pd_distance_km", "avg_total_distance_km",
    "at_customer_time_min", "at_vendor_time_min", "cdt_min",
    "perc_reassignments",
]
...
BASE_LABELS = {
    ...
    "earning_per_week":      "Earnings/week",
    "cpo_local_currency":    "CPO (LC)",
    "net_cpo_lc":            "Net CPO (LC)",
    "perc_stacking":         "Stacking %",
    "avg_sp_distance_km":    "SP dist (km)",
    "avg_pd_distance_km":    "PD dist (km)",
    "avg_total_distance_km": "Total dist (km)",
    "at_customer_time_min":  "At-customer (min)",
    "at_vendor_time_min":    "At-vendor (min)",
    "cdt_min":               "CDT (min)",
    "perc_reassignments":    "Reassignment %",
